...
describe('GiftcardsComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ GiftcardsComponent , AngularFirestore , CardService]
    })
    .compileComponents();
  });
  ...
  beforeEach(() => {
    const input: any[] = [
      { apellido: 'carias', correo: 'prueba@gmail.com', dpi: '30018995910101', edad: '22', nombre: 'carlos', password: 'pass123', username: 'prueba' , id: 'cualquiera'},
    ];
    const data = of(input);
